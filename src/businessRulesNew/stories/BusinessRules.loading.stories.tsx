...
import { IBusinessRulesNewController } from "./BusinessRules.controller";
import { BusinessRulesNewWithLoadingController } from "./BusinessRules.loading.controller";
import { EValueHowToSetUp } from "../enums/EValueHowToSetUp";

const meta: Meta<typeof BusinessRulesNewWithLoadingController> = {
  title: "components/BusinessRulesNew",
  component: BusinessRulesNewWithLoadingController,
  parameters,
  // argTypes: props,
};

type Story = StoryObj<typeof BusinessRulesNewWithLoadingController>;
...
export const loading: Story = (args: IBusinessRulesNewController) => (
  <BusinessRulesNewWithLoadingController {...args} />
);
loading.args = {
