...
import { BusinessRuleViewNew } from "..";
import { EValueHowToSetUp } from "../../../businessRules/enums/EValueHowToSetUp";

const meta: Meta<typeof BusinessRuleViewNew> = {
  title: "components/BusinessRules/BusinessRuleViewNew",
  component: BusinessRuleViewNew,
};
...
const Template: StoryFn<typeof BusinessRuleViewNew> = (args) => (
  <BusinessRuleViewNew {...args} />
);
