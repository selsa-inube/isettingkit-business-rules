...
import { BusinessRuleCardNew } from "..";
import { BusinessRuleViewNew } from "../../../BusinessRuleView";
...
const meta: Meta<typeof BusinessRuleCardNew> = {
  title: "components/BusinessRules/BusinessRuleCardNew",
  component: BusinessRuleCardNew,
  parameters,
  argTypes: props,
};

type Story = StoryObj<typeof BusinessRuleCardNew>;

export const Default: Story = (args: IBusinessRuleCard) => (
  <BusinessRuleCardNew {...args} />
);
Default.args = {
  children: (
    <div>
