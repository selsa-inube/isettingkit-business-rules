...
- fix: verify valid values on form ([@cmarin001](https://github.com/cmarin001))
...
- fix: add a z-index to li in order to avoid wrong overlayer ([@cmarin001](https://github.com/cmarin001))
...
- fix: allow 0 as valid for percentage ([@cmarin001](https://github.com/cmarin001))
...
- fix: allow decimals on range type ([@cmarin001](https://github.com/cmarin001))
...
- fix: adjustment in order to avoid broken form when be no conditions ([@cmarin001](https://github.com/cmarin001))
...
# v2.2.18 (Sat Jan 10 2026)

#### ⚠️ Pushed to `main`

- feat: extened functionality in order to support custom values and custom handle for edits ([@cmarin001](https://github.com/cmarin001))
...
- fix: added support for range message errors ([@cmarin001](https://github.com/cmarin001))
...
- fix: update view to take label instead of value ([@cmarin001](https://github.com/cmarin001))
...
- chore: update input and view dependencies in order to fix render percentage issues ([@cmarin001](https://github.com/cmarin001))
...
- chore: update isettingkit-input version ([@cmarin001](https://github.com/cmarin001))
...
# v2.1.14 (Wed Oct 22 2025)

#### ⚠️ Pushed to `main`

- fix: update configuration for handle list types ([@cmarin001](https://github.com/cmarin001))
...
- fix: update conditions order for tabs ([@cmarin001](https://github.com/cmarin001))
